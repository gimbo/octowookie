...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Opportunity.when'
        db.alter_column(u'contacts_opportunity', 'when', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Opportunity.when'
        db.alter_column(u'contacts_opportunity', 'when', self.gf('django.db.models.fields.DateTimeField')())
