...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Conversation.status'
        db.add_column(u'contacts_conversation', 'status',
                      self.gf('django.db.models.fields.CharField')(default='10 OPEN', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Conversation.status'
        db.delete_column(u'contacts_conversation', 'status')
    ...
    models = {
        ...
        u'contacts.conversation': {
            'Meta': {'ordering': "['status', 'when']", 'object_name': 'Conversation'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'involves': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['contacts.Person']", 'symmetrical': 'False'}),
            'medium': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'notes': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'status': ('django.db.models.fields.CharField', [], {'default': "'10 OPEN'", 'max_length': '20'}),
        ...
        u'contacts.opportunity': {
            ...
            'status': ('django.db.models.fields.CharField', [], {'default': "'10 PENDING'", 'max_length': '20'}),
