...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Conversation.medium'
        db.add_column(u'contacts_conversation', 'medium',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Conversation.medium'
        db.delete_column(u'contacts_conversation', 'medium')
