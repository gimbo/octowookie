...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Company.notes'
        db.alter_column(u'contacts_company', 'notes', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Person.notes'
        db.alter_column(u'contacts_person', 'notes', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Opportunity.notes'
        db.alter_column(u'contacts_opportunity', 'notes', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Conversation.notes'
        db.alter_column(u'contacts_conversation', 'notes', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Company.notes'
        db.alter_column(u'contacts_company', 'notes', self.gf('django.db.models.fields.CharField')(max_length=10000, null=True))

        # Changing field 'Person.notes'
        db.alter_column(u'contacts_person', 'notes', self.gf('django.db.models.fields.CharField')(max_length=10000, null=True))

        # Changing field 'Opportunity.notes'
        db.alter_column(u'contacts_opportunity', 'notes', self.gf('django.db.models.fields.CharField')(max_length=10000, null=True))

        # Changing field 'Conversation.notes'
        db.alter_column(u'contacts_conversation', 'notes', self.gf('django.db.models.fields.CharField')(max_length=10000, null=True))
